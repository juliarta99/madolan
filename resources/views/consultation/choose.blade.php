...
@section('title', 'Pilih Kategori - Konsultasi AI')
...
<div x-data="{category: null}" class="min-h-screen flex items-center justify-center">
    <div class="max-w-4xl flex flex-col gap-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <button type="button" @click="category = 'legalitas'" class="p-4 rounded-lg shadow-xl"
                :class="category == 'legalitas' ? 'bg-primary text-light' : 'bg-light text-dark'"
            >
                Perizinan & Legalitas Usaha
            </button>
            <button type="button" @click="category = 'marketing'" class="p-4 rounded-lg shadow-xl"
                :class="category == 'marketing' ? 'bg-primary text-light' : 'bg-light text-dark'"
            >
                Perizinan & marketing Usaha
            </button>
            <button type="button" @click="category = 'penjualan'" class="p-4 rounded-lg shadow-xl"
                :class="category == 'penjualan' ? 'bg-primary text-light' : 'bg-light text-dark'"
            >
                Perizinan & penjualan Usaha
            </button>
        </div>
