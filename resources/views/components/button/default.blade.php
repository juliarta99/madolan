...
@php
    $base = 'inline-flex items-center justify-center font-medium focus:outline-none transition-all disabled:opacity-50 disabled:cursor-not-allowed transition-all cursor-pointer px-2 text-xs rounded-sm md:px-3 py-1.5 md:text-sm lg:px-6 lg:py-2 lg:text-base lg:rounded-md';
