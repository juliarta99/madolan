    ...
    <div x-data="{
            ...
            editFormAction() {
                ...
                if (this.editMode && this.typeId) {
                    form.action = '/admin/dashboard/pendanaan/type/' + this.typeId;
                    ...
                    form.action = '/admin/dashboard/pendanaan/type';
            ...
            deleteFormAction() {
                ...
                formDelete.action = 'admin/dashboard/pendanaan/type/' + this.typeId;
            },
        }">
