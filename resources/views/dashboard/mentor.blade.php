...
@section('content')
    ...
    <div class="relative z-0">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div class="bg-light shadow-xl p-5 rounded-lg order-1 flex col-span-1 md:col-span-2 gap-4 items-center border border-b-6 border-gray-50 !border-b-primary">
            ...
            <div class="bg-light shadow-xl border border-gray-50 order-3 md:order-2 p-4 rounded-lg flex flex-col items-center justify-center">
            ...
            <div class="bg-light shadow-xl border border-gray-50 p-4 order-4 md:order-3 rounded-lg flex flex-col items-center justify-center">
            ...
            <div class="bg-light shadow-xl p-5 rounded-lg flex order-2 md:order-4 col-span-1 md:col-span-2 gap-4 items-center border border-b-6 border-b-success border-gray-50">
            ...
            <div class="bg-light shadow-xl border border-gray-50 p-4 order-5 rounded-lg flex flex-col items-center justify-center">
                <div class="p-2 rounded-xl bg-primary">
                    <svg class="size-12 stroke-light" viewBox="0 0 46 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M23.25 28.125C26.3566 28.125 28.875 25.6066 28.875 22.5C28.875 19.3934 26.3566 16.875 23.25 16.875C20.1434 16.875 17.625 19.3934 17.625 22.5C17.625 25.6066 20.1434 28.125 23.25 28.125Z" stroke="white" stroke-width="3"/>
                        <path d="M38.6009 20.5013C39.3284 21.3863 39.6922 21.8269 39.6922 22.5C39.6922 23.1731 39.3284 23.6137 38.6009 24.4987C35.9384 27.7312 30.0659 33.75 23.2484 33.75C16.4309 33.75 10.5584 27.7312 7.89594 24.4987C7.16844 23.6137 6.80469 23.1731 6.80469 22.5C6.80469 21.8269 7.16844 21.3863 7.89594 20.5013C10.5584 17.2688 16.4309 11.25 23.2484 11.25C30.0659 11.25 35.9384 17.2688 38.6009 20.5013Z" stroke="white" stroke-width="3"/>
            ...
            <div class="bg-light shadow-xl border border-gray-50 p-4 order-6 rounded-lg flex flex-col items-center justify-center">
