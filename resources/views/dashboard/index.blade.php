    ...
    <div x-data="{ openSaranAI: false  }" class="relative">
        ...
        <div class="mb-4 block md:hidden px-5 py-7 overflow-hidden bg-light rounded-xl border border-gray-300 shadow-xl">
            <div class="flex gap-8 items-center overflow-x-auto">
                <a href="{{ route('dashboard.learning.forum') }}" class="flex gap-1 flex-col items-center">
                ...
                <a href="{{ route('pembelajaran.index') }}" class="flex gap-1 flex-col items-center">
                ...
                <a href="{{ route('dashboard.product.katalog') }}" class="flex gap-1 flex-col items-center">
                ...
                <a href="/pos" class="flex gap-1 flex-col items-center">
                    <svg class="size-6 fill-accent" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="/list-preorder" class="flex gap-1 flex-col items-center">
                ...
                <a href="{{ route('dashboard.keuangan.pembukuan') }}" class="flex gap-1 flex-col items-center">
                ...
                <a href="{{ route('dashboard.keuangan.laporan') }}" class="flex gap-1 flex-col items-center">
                    <svg class="size-6 fill-primary" viewBox="0 0 56 55" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="{{ route('dashboard.keuangan.pendanaan') }}" class="flex gap-1 flex-col items-center">
                    <svg class="size-6 fill-accent" viewBox="0 0 56 55" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="{{ route('consultation.index') }}" class="flex gap-1 flex-col items-center">
                    <svg class="size-6 stroke-primary" viewBox="0 0 101 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M33.8333 73.9583H67.1667M81.75 51.0417H84.875C86.5326 51.0417 88.1223 51.7001 89.2944 52.8722C90.4665 54.0443 91.125 55.6341 91.125 57.2917V65.625C91.125 67.2826 90.4665 68.8723 89.2944 70.0444C88.1223 71.2165 86.5326 71.875 84.875 71.875H81.75M81.75 51.0417C81.7555 48.9882 81.3551 46.9539 80.5718 45.0557C79.7885 43.1575 78.6378 41.4329 77.1858 39.9809C75.7338 38.5289 74.0091 37.3781 72.1109 36.5949C70.2127 35.8116 68.1784 35.4112 66.125 35.4167H34.875C32.8216 35.4112 30.7873 35.8116 28.8891 36.5949C26.9909 37.3781 25.2662 38.5289 23.8142 39.9809C22.3622 41.4329 21.2115 43.1575 20.4282 45.0557C19.6449 46.9539 19.2445 48.9882 19.25 51.0417M81.75 51.0417V71.875M81.75 71.875C81.7555 73.9284 81.3551 75.9627 80.5718 77.8609C79.7885 79.7591 78.6378 81.4838 77.1858 82.9358C75.7338 84.3878 74.0091 85.5385 72.1109 86.3218C70.2127 87.1051 68.1784 87.5055 66.125 87.5H34.875C32.8216 87.5055 30.7873 87.1051 28.8891 86.3218C26.9909 85.5385 25.2662 84.3878 23.8142 82.9358C22.3622 81.4838 21.2115 79.7591 20.4282 77.8609C19.6449 75.9627 19.2445 73.9284 19.25 71.875M19.25 51.0417H16.125C14.4674 51.0417 12.8777 51.7001 11.7056 52.8722C10.5335 54.0443 9.875 55.6341 9.875 57.2917V65.625C9.875 67.2826 10.5335 68.8723 11.7056 70.0444C12.8777 71.2165 14.4674 71.875 16.125 71.875H19.25M19.25 51.0417V71.875M50.5 33.3333V25M50.5 25C52.1576 25 53.7473 24.3415 54.9194 23.1694C56.0915 21.9973 56.75 20.4076 56.75 18.75C56.75 17.0924 56.0915 15.5027 54.9194 14.3306C53.7473 13.1585 52.1576 12.5 50.5 12.5C48.8424 12.5 47.2527 13.1585 46.0806 14.3306C44.9085 15.5027 44.25 17.0924 44.25 18.75C44.25 20.4076 44.9085 21.9973 46.0806 23.1694C47.2527 24.3415 48.8424 25 50.5 25ZM68.2083 55.2083C68.2083 56.8659 67.5499 58.4556 66.3778 59.6278C65.2056 60.7999 63.6159 61.4583 61.9583 61.4583C60.3007 61.4583 58.711 60.7999 57.5389 59.6278C56.3668 58.4556 55.7083 56.8659 55.7083 55.2083C55.7083 53.5507 56.3668 51.961 57.5389 50.7889C58.711 49.6168 60.3007 48.9583 61.9583 48.9583C63.6159 48.9583 65.2056 49.6168 66.3778 50.7889C67.5499 51.961 68.2083 53.5507 68.2083 55.2083ZM45.2917 55.2083C45.2917 56.8659 44.6332 58.4556 43.4611 59.6278C42.289 60.7999 40.6993 61.4583 39.0417 61.4583C37.3841 61.4583 35.7944 60.7999 34.6222 59.6278C33.4501 58.4556 32.7917 56.8659 32.7917 55.2083C32.7917 53.5507 33.4501 51.961 34.6222 50.7889C35.7944 49.6168 37.3841 48.9583 39.0417 48.9583C40.6993 48.9583 42.289 49.6168 43.4611 50.7889C44.6332 51.961 45.2917 53.5507 45.2917 55.2083Z" stroke-width="6.25" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    <p class="font-semibold whitespace-nowrap text-sm md:text-base text-primary">Konsultasi AI</p>
                </a>
            </div>
        </div>
        ...
        <div class="mt-6">
            <h1 class="font-semibold text-xl lg:text-2xl">Akses Cepat ke <span class="text-primary">Fitur Unggulan</span></h1>
                <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4 mt-4">
                    <a href="{{ route('dashboard.learning.forum') }}" class="flex flex-col gap-3 p-4 aspect-square bg-primary text-light w-full rounded-xl shadow-xl items-center justify-center">
                        <img src="{{ asset('assets/icons/forum.svg') }}" class="w-13" alt="">
                        <p>Forum</p>
                    </a>
                    <a href="{{ route('pembelajaran.index') }}" class="flex flex-col gap-3 p-4 aspect-square bg-accent text-light w-full rounded-xl shadow-xl items-center justify-center">
                        <img src="{{ asset('assets/icons/user_reading.svg') }}" class="w-13" alt="">
                        <p>Pembelajaran</p>
                    </a>
                    <a href="{{ route('dashboard.product.katalog') }}" class="flex flex-col gap-3 p-4 aspect-square bg-primary text-light w-full rounded-xl shadow-xl items-center justify-center">
                        <img src="{{ asset('assets/icons/products.svg') }}" class="w-13" alt="">
                        <p>Produk</p>
                    </a>
                    <a href="/pos" class="flex flex-col gap-3 p-4 aspect-square bg-accent text-light w-full rounded-xl shadow-xl items-center justify-center">
                        <img src="{{ asset('assets/icons/pos.svg') }}" class="w-13" alt="">
                        <p>Poin of Sales</p>
                    </a>
                    <a href="/list-preorder" class="flex flex-col gap-3 p-4 aspect-square bg-primary text-light w-full rounded-xl shadow-xl items-center justify-center">
                        <img src="{{ asset('assets/icons/order_edit.svg') }}" class="w-13" alt="">
                        <p>Pre Order</p>
                    </a>
                    <a href="{{ route('dashboard.keuangan.pembukuan') }}" class="flex flex-col gap-3 p-4 aspect-square bg-accent text-light w-full rounded-xl shadow-xl items-center justify-center">
                        <img src="{{ asset('assets/icons/docs.svg') }}" class="w-13" alt="">
                        <p>Pembukuan</p>
                    </a>
                    <a href="{{ route('dashboard.keuangan.laporan') }}" class="flex flex-col gap-3 p-4 aspect-square bg-primary text-light w-full rounded-xl shadow-xl items-center justify-center">
                        <img src="{{ asset('assets/icons/doc.svg') }}" class="w-13" alt="">
                        <p>Laporan</p>
                    </a>
                    <a href="{{ route('dashboard.keuangan.pendanaan') }}" class="flex flex-col gap-3 p-4 aspect-square bg-accent text-light w-full rounded-xl shadow-xl items-center justify-center">
