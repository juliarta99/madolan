    ...
    <div x-data="{
        ...
        editFormAction() {
            ...
            if (this.editMode && this.typeId) {
                form.action = '{{ url('admin/dashboard/keuangan/type') }}/' + this.typeId;
        ...
        deleteFormAction() {
            ...
            formDelete.action = '{{ url('admin/dashboard/keuangan/type') }}/' + this.typeId;
        },
    }">
            ...
            <div class="overflow-x-auto bg-light shadow-xl rounded-lg">
                ...
                >
                    ...
                    >
                        ...
                        <form action="{{ route('admin.dashboard.keuangan.type.store') }}" method="POST" id="form" class="mt-6">
                            @csrf
                            <div class="mb-4">
