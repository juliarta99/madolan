...
@section('content')
    <div class="pb-14">
        ...
        <div x-data x-init="initChart()" class="grid grid-cols-1 md:grid-cols-2 gap-12 my-10">
            <div class="w-full">
                <h1 class="font-semibold text-base md:text-lg text-center mb-5">Chart Penjualan (Jumlah Produk)</h1>
                <canvas id="chartCountProducts"></canvas>
            </div>
            <div class="w-full">
                <h1 class="font-semibold text-base md:text-lg text-center mb-5">Chart Penjualan (Total Pendapatan)</h1>
        ...
        <div x-data="penjualanDummy()" x-init="init()" class="space-y-4">
            <div>
                <h1 class="font-bold mb-2">Laporan Penjualan</h1>
