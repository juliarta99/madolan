...
@section('content')
    <div class="pb-14">
        ...
        <div x-data="kasChart()" x-init="initChart()" class="my-10">
            <h1 class="font-semibold text-lg text-center mb-5">Chart Kas Masuk dan Kas Keluar</h1>
            <canvas id="kasChartCanvas" height="130"></canvas>
        </div>
    
        <div x-data="chartKasHistory()" x-init="initChart()" class="my-10">
            <h1 class="font-semibold text-lg text-center mb-5">Chart Kas Masuk dan Kas Keluar</h1>
            <canvas id="lineKasChart" height="150"></canvas>
        </div>
    
        <div x-data="cashflowDummy()" x-init="init()" class="space-y-4">
            <div>
                <h1 class="font-bold mb-2">Laporan Arus Kas</h1>
                ...
                <table class="w-full table-auto text-sm">
                    ...
                    <tbody class="text-gray-700">
                            ...
                            <tr class="odd:bg-white even:bg-gray-100">
                                ...
                                <td class="px-4 py-2 text-left" x-text="formatRupiah(item.nominal)"></td>
                                <td class="px-4 py-2 text-left" x-text="item.pembayaran"></td>
                ...
                <div class="p-6 rounded-xl shadow-xl border border-gray-50">
                    <div class="flex items-center gap-2">
                        ...
                        <div class="flex flex-col gap-1">
                            <h3 class="font-semibold text-success">Total Kas Masuk</h3>
                            <p class="text-xl font-bold" x-text="formatRupiah(total_masuk)"></p>
                        </div>
                    </div>
                </div>
                <div class="p-6 rounded-xl shadow-xl border border-gray-50">
                    <div class="flex items-center gap-2">
                        ...
                        <div class="flex flex-col gap-1">
                            <h3 class="font-semibold text-danger">Total Kas Keluar</h3>
                            <p class="text-xl font-bold" x-text="formatRupiah(total_keluar)"></p>
                        </div>
                    </div>
                </div>
                <div class="p-6 rounded-xl shadow-xl border border-gray-50">
                    <div class="flex items-center gap-2">
                        <svg viewBox="0 0 24 24" class="fill-primary size-12" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="flex flex-col gap-1">
                            <h3 class="font-semibold text-base md:text-lg text-primary">Kas (<span x-text="start"></span>)</h3>
                            <p class="text-xl font-bold" x-text="formatRupiah(kas_awal)"></p>
                        </div>
                    </div>
                </div>
                <div class="p-6 rounded-xl shadow-xl border border-gray-50">
                    <div class="flex items-center gap-2">
                        ...
                        <div class="flex flex-col gap-1">
                            <h3 class="font-semibold text-base md:text-lg text-primary">Kas (<span x-text="end"></span>)</h3>
                            <p class="text-xl font-bold" x-text="formatRupiah(kas_akhir)"></p>
                        </div>
                    </div>
                </div>
            </div>
...
@section('scripts')
    <script>
        function kasChart() {
            return {
                labels: [
                    '19/08/2025', '20/08/2025', '21/08/2025', 
                    '22/08/2025', '23/08/2025', '24/08/2025', '25/08/2025'
                ],
                dataMasuk: [
                    560000, 1100000, 150000, 660000, 300000, 450000, 200000
                ],
                dataKeluar: [
                    540000, 500000, 250000, 200000, 1100000, 900000, 50000
                ],

                initChart() {
                    const ctx = document.getElementById('kasChartCanvas').getContext('2d');
                    new Chart(ctx, {
                        type: 'bar',
                        data: {
                            labels: this.labels,
        ...
        function chartKasHistory() {
            return {
                ...
                initChart() {
                    const ctx = document.getElementById('lineKasChart').getContext('2d');
            ...
            return {
                ...
                fetchData() {
                    ...
                    this.transaksi = Array.from({ length: 10 }).map((_, i) => ({
                        ...
                        tipe: 'Pemasukan',
                        deskripsi: 'Ice Coffee terjual 2',
                        nominal: 80000,
                        pembayaran: 'Cash',
                    }))

                    this.total_masuk = 12150000
                    this.total_keluar = 7490000
                    this.kas_akhir = this.kas_awal + this.total_masuk - this.total_keluar
                },
