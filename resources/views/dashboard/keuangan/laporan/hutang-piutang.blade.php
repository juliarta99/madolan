...
@section('content')
    <h1 class="text-3xl font-bold mb-4">Laporan Hutang Piutang</h1>
    ...
    <div x-data x-init="initChart()" class="grid grid-cols-2 gap-12 my-10">
        <div class="w-full">
            <h1 class="font-semibold text-lg text-center mb-5">Chart Hutang</h1>
            <canvas id="chartHutang"></canvas>
        </div>
        <div class="w-full">
            <h1 class="font-semibold text-lg text-center mb-5">Chart Piutang</h1>
            <canvas id="chartPiutang"></canvas>
        </div>
        <div class="w-full col-span-2">
            <h1 class="font-semibold text-lg text-center mb-5">Chart Hutang Piutang</h1>
