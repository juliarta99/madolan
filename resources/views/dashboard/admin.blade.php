...
@section('content')
    ...
    <div class="relative z-0">
        ...
        <div class="grid md:grid-cols-4 gap-6">
            ...
            <div class="bg-light shadow-xl border border-gray-50 p-4 rounded-lg flex flex-col items-center justify-center">
                <div class="p-2 rounded-xl bg-warning">
                    <svg width="46" height="45" class="size-12 fill-dark" viewBox="0 0 46 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M42 23.2687V7.5C42 6.50544 41.6049 5.55161 40.9016 4.84835C40.1984 4.14509 39.2446 3.75 38.25 3.75H8.25C7.25544 3.75 6.30161 4.14509 5.59835 4.84835C4.89509 5.55161 4.5 6.50544 4.5 7.5V41.25L12 33.75H18.1687C19.0698 36.7714 21.0282 39.3675 23.686 41.0637C26.3437 42.76 29.5231 43.443 32.643 42.9878C35.7629 42.5327 38.6147 40.9699 40.6771 38.5851C42.7395 36.2003 43.8746 33.1529 43.875 30C43.875 27.5438 43.1813 25.2375 42 23.2687ZM10.4438 30L8.25 32.1938V7.5H38.25V19.2375C36.0524 17.6976 33.4334 16.8727 30.75 16.875C27.1875 16.875 23.9437 18.3188 21.5812 20.625H12V24.375H18.9187C18.0937 26.0812 17.625 27.9937 17.625 30H10.4438ZM30.75 39.0938C25.725 39.0938 21.6562 35.025 21.6562 30C21.6562 24.975 25.725 20.9062 30.75 20.9062C35.7563 20.9062 39.8438 24.975 39.8438 30C39.8438 35.025 35.7563 39.0938 30.75 39.0938ZM34.5 16.875H12V13.125H34.5V16.875ZM31.6875 29.6625L36.2625 32.3062L34.8563 34.7438L28.875 31.2938V24.375H31.6875V29.6625Z" />
                    </svg>
                </div>
        ...
        <div x-data="chartLabaRugi()" x-init="initChart()" class="my-10">
            <h1 class="font-semibold text-lg text-center mb-5">Chart Transaksi</h1>
