                    ...
                    >
                        ...
                        >
                            ...
                            <div class="my-6 space-y-2">
                                <p class="text-base font-semibold">Rentang Tanggal</p>
                                <div class="grid grid-cols-2 gap-2">
                                    <div class="">
                                        <x-label class="!text-sm" for="sort_by">Dari Tanggal</x-label>
                                        <x-input.default type="date"
                                            name="start-date"
                                        />
                                    </div>
                                    <div class="">
                                        <x-label class="!text-sm" for="sort_by">Sampai Tanggal</x-label>
                                        <x-input.default type="date"
                                            name="until-date"
                                        />
                                    </div>
